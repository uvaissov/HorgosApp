...
export const doUpdateProfile = async (online = true, token, name, email, password, passwordConfirm, avatar) => {
  const data = online ? await apiManager.doUpdateProfile(token, name, email, password, passwordConfirm, avatar) : null
  return data
}
